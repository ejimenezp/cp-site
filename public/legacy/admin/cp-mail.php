...
function getClient() {
	...
	$credentialsPath = './gmail-php-client.json';
...
function CP_mail_to_user($r, $mail_template)
{
	...
	$html_body = set_booking_data($r, $mail_template . ".html");
	$txt_body = set_booking_data($r, $mail_template . ".txt");
...
function CP_mail_to_admin($r, $from_string, $to_string, $subject_string, $mail_template)
{
	...
	$mail_body = set_booking_data($r, $mail_template);
